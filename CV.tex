...
\newcounter{birth}
\newcounter{today}
\setmydatenumber{birth}{1984}{12}{09}
\setmydatenumber{today}{\the\year}{\the\month}{\the\day}
\FPsub\result{\thetoday}{\thebirth}
...
\cvitem{Programmation}{Python, HTML, CSS, Javascript/Typescript, Vue.js, Go, C/C++, informatique
  embarquée.}
